...
class ModernConnectivityGUI(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.setWindowTitle("SedInConnect 3.1 - Sediment Connectivity Tool")
        ...
        self.append_console("""
###############################################################################
SedInConnect 3.1 - Sediment Connectivity Index Tool
...
Ready to start processing...
    ...
    def create_sidebar(self) -> QWidget:
        ...
        description = QLabel(
            ...
            "<i>SedInConnect 3.1</i> represents a major advancement in connectivity analysis with native Python algorithms."
        )
        ...
        version_label = QLabel("<b>Version 3.1 (2026)</b><br>Stefano Crema<br>Marco Cavalli")
    ...
    def validate_inputs(self) -> Optional[ProcessingParams]:
        ...
        params = ProcessingParams(
            ...
            roughness_path=Path(self.roughness_output_input.text()) if (hasattr(self, 'roughness_output_input') and self.roughness_output_input.text()) else None,
            weight_output_path=Path(self.weight_output_input.text()) if (hasattr(self, 'weight_output_input') and self.weight_output_input.text()) else None,
            d_up_path=Path(self.dup_output_input.text()) if (hasattr(self, 'dup_output_input') and self.dup_output_input.text()) else None,
            d_down_path=Path(self.ddown_output_input.text()) if (hasattr(self, 'ddown_output_input') and self.ddown_output_input.text()) else None,
    ...
    def show_help(self):
        ...
        help_dialog.setWindowTitle("SedInConnect 3.1 - Help & Documentation")
        ...
        help_text = """
<h2 style="color: #2196F3;">SedInConnect 3.1 - User Guide</h2>
<p><b>Version 3.1 (2026)</b><br>
...
quantifies this connectivity.</p>
        ...
        help_label2.setText("""
<hr><h3 style="color: #4CAF50;">How to Use SedInConnect 3.1</h3>
